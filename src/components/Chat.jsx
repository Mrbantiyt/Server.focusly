...
const SITES = [
  // "I'm Feeling Lucky" search: goes through Google, then auto-redirects
  // straight to the top result (Gemini's official site) instead of showing
  // a results page.
  { id: "gemini", label: "Gemini", url: "https://www.google.com/search?q=gemini&btnI=1", icon: Sparkles, desc: "Make notes" },
